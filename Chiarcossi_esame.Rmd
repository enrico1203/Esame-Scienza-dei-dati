...
output:
  ioslides_presentation:
    css: 'C:\Users\chiar\Desktop\R\Esame\scroll.css'
    incremental: yes
  slidy_presentation:
    incremental: yes
editor_options:
...
![](C:\Users\chiar\Desktop\R\Esame\nuovi_contenuti.gif){Height=99%}
</div>
```{r, echo=FALSE, message=FALSE, warning=FALSE}
...
![](C:\Users\chiar\Desktop\R\Esame\eta_servizi.gif){Height=99%}
</div>
